...
class DashboardItem extends GetView<DashboardController> {
  final int? index;
  final SofUserModel? data;

  const DashboardItem({super.key, this.index, this.data});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: $r.theme.shadow, offset: Offset(0, 4.w), blurRadius: 16)],
        border: Border(left: BorderSide(width: 6.w, color: $theme.colorScheme.primary.withValues(alpha: 0.5))),
      ),
      child: TapSplash(
        radius: 14.r,
            ...
            children: [
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () => controller.toggleFavorite(data ?? const SofUserModel()),
                ),
              ),
                      ...
                      child: Row(
                        ...
                        children: [
                          badges.Badge(
                            ...
                            badgeContent: Icon(FluentIcons.checkmark_16_regular, color: Colors.white, size: 10.sp),
                            badgeStyle: badges.BadgeStyle(
                              shape: badges.BadgeShape.twitter,
                              badgeColor: $theme.colorScheme.primary,
                            ),
                            child: ProfileImageWidget(data?.profileImage ?? ''),
                          ),
                          Gap(16.w),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Icon(FluentIcons.star_20_filled, color: $theme.colorScheme.primary, size: 16.sp),
                                    Gap(4.w),
                                    Text(
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                    flex: 2,
                                    child: SvgAsset(Assets.svgs.bronzeMedal.path, width: 24.w, height: 24.h),
                                  ),
                                  Gap(4.h),
                                  Expanded(
                                    child: Text("${data?.badgeCounts?.bronze?.formatted ?? 0}", style: text14.medium),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                    flex: 2,
                                    child: SvgAsset(Assets.svgs.sliverMedal.path, width: 24.w, height: 24.h),
                                  ),
                                  Gap(4.h),
                                  Expanded(
                                    child: Text("${data?.badgeCounts?.silver?.formatted ?? 0}", style: text14.medium),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                    flex: 2,
                                    child: SvgAsset(Assets.svgs.goldMedal.path, width: 24.w, height: 24.h),
                                  ),
                                  Gap(4.h),
                                  Expanded(
                                    child: Text("${data?.badgeCounts?.gold?.formatted ?? 0}", style: text14.medium),
                                  ),
                                ],
                              ),
                            ),
