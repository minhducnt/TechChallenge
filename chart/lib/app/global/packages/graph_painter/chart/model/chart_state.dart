  ...
  static ChartState<T?> lerp<T>(ChartState<T?> a, ChartState<T?> b, double t) {
    return ChartState<T?>._lerp(
      ...
      backgroundDecorations: b.backgroundDecorations.map<DecorationPainter>((e) {
        final match = a.backgroundDecorations.firstWhereOrNull((element) => element.isSameType(e));
        if (match != null) {
          return match.animateTo(e, t);
        }
      ...
      foregroundDecorations: b.foregroundDecorations.map((e) {
        final match = a.foregroundDecorations.firstWhereOrNull((element) => element.isSameType(e));
        if (match != null) {
          return match.animateTo(e, t);
        }
