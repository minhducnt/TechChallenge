...
class DecorationsRenderer<T> extends MultiChildRenderObjectWidget {
  DecorationsRenderer(List<DecorationPainter> fixedDecoration, this.chartState, {super.key})
    : super(children: fixedDecoration.map((e) => e.getRenderer(chartState)).toList());
